            ...
            <div className="bg-[#EAEFF5] p-5 md:p-10 lg:p-14 rounded-[24px] md:rounded-[40px] lg:rounded-[50px] shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
                <div className="space-y-3">
                  <label className={`text-[10px] md:text-[11px] font-black uppercase tracking-widest ml-1 ${errors.firstName ? 'text-red-500' : 'text-gray-400'}`}>
                    FIRST NAME
                  </label>
                  <input 
                    value={formData.firstName} 
                    onChange={e => handleInputChange('firstName', e.target.value)}
                    className={`w-full px-4 py-3.5 md:px-6 md:py-5 bg-white rounded-xl md:rounded-2xl border-none outline-none font-bold text-base shadow-sm transition-all focus:ring-2 ${errors.firstName ? 'ring-2 ring-red-500 text-red-600 placeholder:text-red-300' : 'focus:ring-indigo-100 text-gray-700'}`} 
                    placeholder="First Name"
                  />
                </div>
                <div className="space-y-3">
                  <label className={`text-[10px] md:text-[11px] font-black uppercase tracking-widest ml-1 ${errors.lastName ? 'text-red-500' : 'text-gray-400'}`}>
                    LAST NAME
                  </label>
                  <input 
                    value={formData.lastName} 
                    onChange={e => handleInputChange('lastName', e.target.value)}
                    className={`w-full px-4 py-3.5 md:px-6 md:py-5 bg-white rounded-xl md:rounded-2xl border-none outline-none font-bold text-base shadow-sm transition-all focus:ring-2 ${errors.lastName ? 'ring-2 ring-red-500 text-red-600 placeholder:text-red-300' : 'focus:ring-indigo-100 text-gray-700'}`} 
                ...
                <div className="space-y-3">
                   <label className={`text-[10px] md:text-[11px] font-black uppercase tracking-widest ml-1 ${errors.location ? 'text-red-500' : 'text-gray-400'}`}>
                    CITY
                  </label>
                  <input 
                    value={formData.location} 
                    onChange={e => handleInputChange('location', e.target.value)}
                    className={`w-full px-4 py-3.5 md:px-6 md:py-5 bg-white rounded-xl md:rounded-2xl border-none outline-none font-bold text-base shadow-sm transition-all focus:ring-2 ${errors.location ? 'ring-2 ring-red-500 text-red-600 placeholder:text-red-300' : 'focus:ring-indigo-100 text-gray-700'}`} 
                    placeholder="Dhaka, Chittagong..."
                  />
                </div>

                <div className="space-y-3">
                   <label className={`text-[10px] md:text-[11px] font-black uppercase tracking-widest ml-1 ${errors.zipCode ? 'text-red-500' : 'text-gray-400'}`}>
                    ZIP CODE
                  </label>
                  <input 
                    value={formData.zipCode} 
                    onChange={e => handleInputChange('zipCode', e.target.value)}
                    className={`w-full px-4 py-3.5 md:px-6 md:py-5 bg-white rounded-xl md:rounded-2xl border-none outline-none font-bold text-base shadow-sm transition-all focus:ring-2 ${errors.zipCode ? 'ring-2 ring-red-500 text-red-600 placeholder:text-red-300' : 'focus:ring-indigo-100 text-gray-700'}`} 
                    placeholder="1230"
                  />
                </div>
